...
('Guitarra','Agenda tu clase de guitarra y desarrolla tu potencial musical con nuestros profesores calificados',1,15.00,1,1),
('Piano/Teclado','Agenda tu clase de piano/teclado y desarrolla tu potencial musical con nuestros profesores calificados',1,15.00,1,1),
('Producción Musical','Confía en nosotros para llevar tu musica al siguiente nivel y crear una producción que destaque',1,15.00,1,2),
('Técnica Vocal','Agenda tu clase de técnica vocal y desarrolla tu potencial musical con nuestros profesores calificados',1,15.00,1,2),
('Teoría Musical','Aprende de teoría musical de la mano de nuestros profesores calificados',1,15.00,1,2),
...
('Captura de Instrumentos','Si necesitas grabar instrumentos te brindamos asistencia tecnica y un entorno óptimo para lograr el mejor sonido posible',1,15.00,1,6),
('Captura de Voces','Si necesitas grabar voces te brindamos asistencia tecnica y un entorno óptimo para lograr el mejor sonido posible',1,15.00,1,7),
('Foley','Si necesitas grabar foley te brindamos asistencia tecnica y un entorno óptimo para lograr el mejor sonido posible',4,NULL,1,8),
...
('Producción Musical','Confía en nosotros para llevar tu música al siguiente nivel y crear una producción que destaque!',4,NULL,1,10),
...
('Masterización','Destaca con confianza en cada reproducción y deja que tu música brille con nuestro servicio de masterización',3,120.00,1,12),
('Mezcla','Confía en nuestro servicio de mezcla para lograr un sonido equilibrado y atractivo de la mano de nuestro equipo de ingenieros de sonido',3,120.00,1,13);
